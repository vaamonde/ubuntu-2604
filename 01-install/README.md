# Curso GRÁTIS de GNU/Linux Ubuntu Server 26.04.x LTS (Resolute Raccoon) Essentials
...
## **🤩🤩 Instalação do Ubuntu Server 26.04.x LTS no Oracle VirtualBOX Projeto Bora para Prática 🤩🤩**
